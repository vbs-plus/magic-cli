...
const magicCliModels = require('magic-cli-models');
const require$$0 = require('os');
const semver$1 = require('semver');
...
const semver__default = /*#__PURE__*/_interopDefaultLegacy(semver$1);
...
function requireDelayed_stream () {
	...
	var Stream = require$$3__default.Stream;
	var util = require$$1__default$1;
...
function requireForm_data () {
	...
	var http = require$$1__default$2;
	var https = require$$2__default;
	var parseUrl = require$$0__default$1.parse;
	var fs = require$$6__default;
	var Stream = require$$3__default.Stream;
...
const request = /*@__PURE__*/getDefaultExportFromCjs(axios$2.exports);

var semverRegex$1 = () => /(?:(?<=^v?|\sv?)(?:(?:0|[1-9]\d{0,9}?)\.){2}(?:0|[1-9]\d{0,9}?)(?:-(?:0|[1-9]\d*?|[\da-z-]*?[a-z-][\da-z-]*?){0,100}?(?:\.(?:0|[1-9]\d*?|[\da-z-]*?[a-z-][\da-z-]*?))*?){0,100}?(?:\+[\da-z-]+?(?:\.[\da-z-]+?)*?){0,100}?\b){1,200}?/gi;

var semver = semver__default;
...
const { error, echo, warn } = magicCliUtils.useLogger();
const homePath = require$$0__default.homedir();
