...
const _axios = /*@__PURE__*/getDefaultExportFromCjs(axios$2.exports);
...
MongoDBDataAPI.prototype.$$action = function $$action (name, params, axiosConfig) {
    ...
    return __classPrivateFieldGet(this, _MongoDBDataAPI_axios, "f").call(this, Object.assign({ method: 'post', data: JSON.stringify(mergedParams), url: __classPrivateFieldGet(this, _MongoDBDataAPI_config, "f").urlEndpoint
            ? getActionUrl(__classPrivateFieldGet(this, _MongoDBDataAPI_config, "f").urlEndpoint, name)
            : getActionUrl(getUrlEndpoint(__classPrivateFieldGet(this, _MongoDBDataAPI_config, "f").appId, __classPrivateFieldGet(this, _MongoDBDataAPI_config, "f").region), name), headers: ( obj = {
            'Content-Type': 'application/json',
            'Access-Control-Request-Headers': '*'
        }, obj[API_KEY_FIELD] = __classPrivateFieldGet(this, _MongoDBDataAPI_config, "f").apiKey, obj ) }, axiosConfig))
...
var MONGO_API_CONFIG = /* @__PURE__ */ ((MONGO_API_CONFIG2) => {
  MONGO_API_CONFIG2["API_KEY"] = "HR0ppovwDQc2VatXxGRW6oGYW7SGcNpzPNZRqkWF1MJW1cuFZ5xWiA0JCcC8zUKr";
  MONGO_API_CONFIG2["API_BASE_URL"] = "https://data.mongodb-api.com/app/data-buykb/endpoint/data/v1";
  MONGO_API_CONFIG2["DATASOURCE"] = "Cluster0";
  MONGO_API_CONFIG2["DATABASE"] = "projects";
  MONGO_API_CONFIG2["COLLECTION"] = "templates";
  return MONGO_API_CONFIG2;
})(MONGO_API_CONFIG || {});
...
const getTemplateByNpmName = async (npmName) => {
  return request.findOne({
    ...commnBodyParams,
    filter: { npmName }
  }).then((res) => res.document);
};
const addSingleTemplate = async (params) => {
  return request.insertOne({
    ...commnBodyParams,
    document: params
  });
};
const addMultiTemplate = async (params) => {
  return request.insertMany({
    ...commnBodyParams,
    documents: params
  });
};
const updateSingleTemplateByNpmName = async (npmName, params) => {
...
const deleteTemplateByNpmName = async (npmNames) => {
...
exports.addMultiTemplate = addMultiTemplate;
exports.addSingleTemplate = addSingleTemplate;
exports.deleteTemplateByNpmName = deleteTemplateByNpmName;
exports.getTemplateByNpmName = getTemplateByNpmName;
exports.getTemplateListByType = getTemplateListByType;
exports.updateSingleTemplateByNpmName = updateSingleTemplateByNpmName;
